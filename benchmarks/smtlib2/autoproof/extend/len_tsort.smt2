...
(declare-datatypes ((Nat 0)) (((zero) (succ (succ0 Nat)))))

(declare-datatypes ((Iint 0)) (((cint (cint0 Int)))))

(declare-datatypes ((List 0)) (((nil) (cons (cons0 Iint) (cons1 List)))))

(declare-datatypes ((Tree 0)) (((leaf (leaf0 Iint)) (bin (bin0 Tree) (bin1 Tree)))))
